...
def test_override_class(
        ...
        expected_test_overridden_params_dict: dict[str, bool],
) -> None:
    ...
    for override_key, test_key in zip(overriden_params_dict.keys(), expected_test_overridden_params_dict.keys(),
                                      strict=True):
